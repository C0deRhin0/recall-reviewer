...
export default function Bank({
  ...
  const [bank, setBank] = useState<BankData | null>(null),
    ...
    >([]);
  const canManage = dashboard.user.demo || dashboard.user.aal2;
  async function load() {
  ...
  return (
    <>
      <div className="page-heading">
        <div>
          <h1>Published question bank</h1>
          <p className="subtle">
            Review and publish the questions available to every learner.
          </p>
        </div>
        {bank?.active && (
          <button
      ...
      {!canManage ? (
        <section className="empty-state">
          ...
          <p>
            Verify your authenticator in Settings before managing the published
            question bank.
          </p>
          <a className="button primary" href="/?view=settings">
            Open Settings →
          </a>
        </section>
      ) : (
        <>
          ...
          <section className="section-block import-panel">
            ...
            <details className="import-help">
              ...
              <p>
                Use JSON for a new bank; CSV inherits the active bank’s
                categories.
              </p>
            </details>
            ...
            <div className="import-actions">
              <div className="action-strip">
                <button
                  ...
                  onClick={() =>
                    run(async () => {
                      setPreview(
                        await api<Preview>("bank/preview", {
                          raw,
                          format,
                          mode,
                        }),
              ...
              <span className="fine-print">
                2 MiB maximum · 1,000 questions per import · Exactly four
                options
              </span>
            </div>
            {mode === "replace" && (
            ...
            {preview && (
              <section className="import-preview">
                <div className="section-heading">
                  ...
                  <span className="mono">
                    {preview.count} QUESTIONS IN RESULT
                  </span>
                </div>
                ...
                <div className="change-list">
                  {preview.changes.map((c) => (
                    <details key={c.id}>
                      <summary>
                        <span className={"change-kind " + c.kind}>
                          {c.kind}
                        </span>
          ...
          <section className="section-block">
            ...
            {bank?.releases.length ? (
              ...
              <div className="empty-state">
                <h3>No releases</h3>
                <p>
                  Validate a JSON bank, review its questions, then save and
                  publish it.
                </p>
              </div>
            )}
            ...
            <Modal titleId="publish-title" onClose={() => setActivate(null)}>
              <section className="modal">
                ...
                <p>
                  ...
                  . Saved sessions and their scores retain their original
                  content.
                </p>
                <div className="action-strip">
                  <button
